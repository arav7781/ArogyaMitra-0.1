          ...
          <div className="p-6">
            ...
            <Tabs defaultValue="sounds" value={activeTab} onValueChange={setActiveTab} className="w-full mt-6">
              <TabsList className="grid grid-cols-5 mb-4 bg-white/10 p-1">
                <TabsTrigger
                  value="sounds"
                  className="text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-indigo-500 data-[state=active]:text-white"
                >
...
const MoodDashboard = ({ logs, currentMood }) => {
  ...
  return (
    <Card className="absolute bottom-4 right-4 w-80 backdrop-blur-lg bg-black/40 border-none shadow-xl">
      <div className="p-4">
        <Button
