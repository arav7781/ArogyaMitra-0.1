...
const DeveloperInfo = () => {
  const developers = [
    {
      name: "DataWizards",
      role: "AI Alchemists & Full-Stack Crafters",
      bio: "We are a dynamic team turning complex challenges into smart solutions. With our powers combined -AI, full-stack, and domain expertise -we build, innovate, and deliver as one cohesive force.",
      image: "/Dataa.png",
    ...
    //   name: "Team Member",
    //   role: "AI Specialist",
    //   bio: "Expert in machine learning models for healthcare diagnostics.",
    //   image: "/placeholder.svg?height=150&width=150",
    //   github: "#",
    //   linkedin: "#",
    // },
      ...
      <div className="developer-container">
        ...
        <div className="developer-grid">
          {developers.map((dev, index) => (
            ...
            >
              <div className="developer-image animate-pulse">
