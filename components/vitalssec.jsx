...
export function  FeaturesSectionDemo() {
  const features = [
    {
      ...
      description:
        "Experience ArogyaMitra in multiple languages, making it accessible to a global audience.",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "Meditate using MoodScape",
      description:
        "Experience the power of meditation with MoodScape, our intuitive and user-friendly interface.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Watch our Teaser on YouTube",
      description:
        "Whether its you or Elon Musk, anyone can get to know about our product on YouTube",
    ...
    },
    {
      ...
      description:
        "With our blazing fast, state of the art, cutting edge, you can connect from anywhere.",
  ...
  return (
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto bg-transparent">
      <div className="px-8">
        <h4
          ...
          <GradientText>Packed with thousands of features</GradientText> 
        </h4>

        <p
          className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From Voice to Voice communication to vitals monitoring, ArogyaMitra has built-in features for everything.
          Vision and Thinking ArogyaBot which understand the needs of the user and provide the best possible response.
        </p>
      </div>
...
const FeatureCard = ({
  ...
  return (
    <div className={cn(`p-4 sm:p-8 relative overflow-hidden bg-white dark:bg-neutral-800 position-relative rounded-2xl bg-transparent`, className)}>
      {children}
    </div>
  );
};
...
export const SkeletonOne = () => {
  return (
    <BlurFade delay={0.8} inView>
    <div className="relative flex py-8 px-2 gap-10 h-full bg-transparent">
      <div
...
export const SkeletonThree = () => {
  return (
    <BlurFade delay={0.8} inView>
    <a
      href="https://www.youtube.com/watch?v=7zJOWGTwzXQ"
      target="__blank"
...
export const SkeletonTwo = () => {
  ...
  return (
    ...
    <div
      className="relative flex flex-col items-start p-8 gap-10 h-full overflow-hidden bg-white">
      {/* TODO */}
