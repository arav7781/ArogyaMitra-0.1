...
const Hyperspeed = ({ effectOptions = {
    ...
    colors: {
      roadColor: 0xFFFFFF,        // Black (for contrast)
      islandColor: 0xFFFFFF,      // WHITE (Middle of flag)
      background: 0xFFFFFF,       // Black background
      shoulderLines: 0xFFFFFF,    // White lines
      brokenLines: 0xFFFFFF,      // White broken lines
      leftCars: [0xFF9933, 0xFF5722],  // SAFFRON (Top of flag)
      rightCars: [0x138808, 0x0A7E07], // GREEN (Bottom of flag)
      sticks: 0xFFFFFF,           // White light sticks
    }
